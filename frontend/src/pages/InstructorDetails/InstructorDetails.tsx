                            ...
                            <div className="pb-2">
                                ...
                                {instructor.avgRating !== undefined && instructor.avgRating > 0 && (
                                    <div className="flex items-center text-yellow-500 my-1">
                                        ...
                                        <span className="font-bold text-lg">{instructor.avgRating.toFixed(1)}</span>
                                        <span className="text-sm text-gray-500 dark:text-gray-400 ml-2">({instructor.totalReviews} reviews)</span>
                                    </div>
                                )}
